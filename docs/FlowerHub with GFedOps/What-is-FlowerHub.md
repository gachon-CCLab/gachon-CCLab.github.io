...
- FlowerHub provides Flower Apps for federated learning.
- Users can import an app and reuse it as a project template.
- Apps can be modified for new tasks and shared with other users.
